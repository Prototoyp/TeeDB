 ...
 */
class Migration_TeeDB_Maps extends MY_Migration {
...
// 
            ...
            $this->db->query("
				CREATE TABLE IF NOT EXISTS ".$this->db->dbprefix($this->map->get_table())." (
	...
	function down() 
	{
		$this->dbforge->drop_table($this->map->get_table());
	}
}
