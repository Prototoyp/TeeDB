...
// 
            ...
            $this->db->query("
				CREATE TABLE IF NOT EXISTS ".$this->db->dbprefix($this->tileset->get_table())." (
	...
	function down() 
	{
		$this->dbforge->drop_table($this->tileset->get_table());
	}
}
