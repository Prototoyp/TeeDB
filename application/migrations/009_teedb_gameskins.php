 ...
 */
class Migration_TeeDB_Gameskins extends MY_Migration {
...
// 
            ...
            $this->db->query("
				CREATE TABLE IF NOT EXISTS ".$this->db->dbprefix($this->gameskin->get_table())." (
	...
	function down() 
	{
		$this->dbforge->drop_table($this->gameskin->get_table());
	}
}
